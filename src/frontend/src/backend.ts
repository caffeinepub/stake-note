...
import type { DiaryEntry as _DiaryEntry, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createEntry(arg0: string, arg1: string, arg2: Array<string>): Promise<EntryId> {
        if (this.processError) {
            try {
    ...
    async getEntriesByPage(arg0: bigint, arg1: bigint): Promise<Array<DiaryEntry>> {
        if (this.processError) {
            try {
                const result = await this.actor.getEntriesByPage(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getEntry(arg0: EntryId): Promise<DiaryEntry | null> {
        if (this.processError) {
            try {
    ...
    async searchEntries(arg0: string): Promise<Array<DiaryEntry>> {
        if (this.processError) {
            try {
    ...
    async updateEntry(arg0: EntryId, arg1: string, arg2: string, arg3: Array<string>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateEntry(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_opt_n6(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_DiaryEntry]): DiaryEntry | null {
    return value.length === 0 ? null : value[0];
}
